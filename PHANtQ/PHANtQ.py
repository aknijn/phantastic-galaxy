...
def __main__():
    ...
    strContamination = 'No'
    subprocess.run("kmerfinder.py  -i " + args.input + " -db /gfs/data-flow/KmerFinder/bacteria/bacteria.ATG -tax /gfs/data-flow/KmerFinder/bacteria/bacteria.tax -o output")
